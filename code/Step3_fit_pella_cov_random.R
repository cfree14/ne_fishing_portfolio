...
# p <- 1; covariate <- "sst_c_scaled"; covariate_name <- "sst"
fit_sp <- function(data, covariate, covariate_name, p){
  ...
  # Outfile name
  outfile <- paste0("pella_", "", format(p, nsmall=2), "p_random_", covariate_name, ".Rdata")
